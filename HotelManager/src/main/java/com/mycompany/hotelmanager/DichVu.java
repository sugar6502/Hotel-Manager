...
public class DichVu extends javax.swing.JFrame {
    ...
    public List<Integer> MaDVFinal;
    public DichVu() {
        initComponents();
    }
    public DichVu(String SoPhong) {
        initComponents();
        MaDVFinal= new ArrayList<>();
        this.SoPhong = SoPhong;
        lb_SoPhong.setText(SoPhong);
    ...
    private void cb_DichVuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_DichVuActionPerformed
        ...
        DefaultTableModel tmodel = (DefaultTableModel) tb_DV.getModel();
        
        String row[] = new String[3];
        row[0] = Integer.toString(tmodel.getRowCount()+1);
        row[1] = model.LayTenDichVu(Madv);
        row[2] = Integer.toString(model.LayDonGiaDichVu(Madv));
        
        //cb_DichVu.removeItem(cb_DichVu.getSelectedItem());
        tmodel.addRow(row);
    ...
    public List<Integer> getMaDVFinal() {
        System.out.println("1");
        for (int madv : MaDVFinal) {
